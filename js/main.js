...
$(function() {
        var bookmark = {
            data: [{
                name: '咨询',
                link: 'https://menglingji.com/zixun',
                box_shadow: '#F18033',
                icon: 'img/1.jpg',
            },   {
                name: '感想',
                link: 'https://menglingji.com/ganxiang',
                box_shadow: '#F2584A',
                icon: 'img/2.jpg',
            }, {
                name: '游戏',
                link: 'https://dl.menglingji.com/category/game-2/',
                box_shadow: '#0078D8',
                icon: 'img/3.jpg',
            }, {
                name: '动漫',
                link: 'https://dl.menglingji.com/category/%e5%8a%a8%e6%bc%ab%e7%95%aa%e5%89%a7/',
                box_shadow: '#F57923',
                icon: 'img/4.jpg',
            }, {
                name: '网盘',
                link: 'https://yyddtj.top',
                box_shadow: '#2C2C2C',
                icon: 'img/5.jpg',
            }, {
                name: '会员购',
                link: 'https://store.menglingji.com/',
                box_shadow: '#37bf4c',
                icon: 'img/6.jpg',
            }, {
                name: '资料',
                link: 'https://acgfan.cf/',
                box_shadow: '#c01d2f',
                icon: 'img/7.jpg',
            }, {
                name: '秒传',
                link: 'https://638ac9b288562746fe62c1e3--monumental-boba-868492.netlify.app/',
                box_shadow: '#fe7700',
                icon: 'img/8.jpg',
            }]
        }
